...
if __name__ == '__main__':
    ...
    model = YOLO("D:/Deeplearning_code/yolov8/ultralytics/runs/detect/train/weights/best.pt")
    ...
    # results = model.predict(source='D:/A_my_study/visdrone/yolov5_r/temp',save=True)