...
if __name__ == '__main__':
    # model = YOLO("D:/Deeplearning_code/yolov8/ultralytics/ultralytics/cfg/models/v8/custom/yolov8_simulate_inf.yaml")  # 从头开始构建新模型
    model = YOLO("D:/Deeplearning_code/yolov8/ultralytics/runs/detect/only_car/best.pt")
